...
BW                  : 60      : kg,                  Bodyweight (ICRP 2002)
QCC                 : 16.42   : L/h/kg^0.75,         ICRP 2002
QLC                 : 0.27    : Unitless,            Fraction blood flow to liver (ICRP 2002)
QLuC                : 0.025   : Unitless,            Pulmonary circulation equals systemic circulation(ICRP 2002)
QKC                 : 0.17	  : Unitless,            Fraction blood flow to kidney (ICRP 2002)
Htc                 : 0.385   : Unitless,            Hematocrit for human(ICRP 2002)
VPlasC              : 0.04    : L/kg BW,             Fractional plasma (ICRP 2002)
VLC                 : 0.0233  : Unitless,            Fractional liver tissue (ICRP 2002)
VLuC                : 0.007   : Unitless,            Fractional lung tissue (ICRP 2002)
VKC                 : 0.0046  : Unitless,            Fractional kidney tissue (ICRP 2002)
VfilC               : 0.00046 : L/kg BW,             Fraction vol. of filtrate; 10% of Kidney volume; (Worley and Fisher et al., 2015)
GFRC                : 27.28   : L/hr/kg kiney,       Glomerular filtration rate (male) (Corley, 2005)
...
Free                : 0.0704 : Unitless,            Free fraction; (from Mice PBPK model)  
PL                  : 1.0649 : Unitless,            Liver     / plasma PC; (from Mice PBPK model) 
PLu                 : 0.331  : Unitless,            Lung      / plasma PC; (from Mice PBPK model)
PK                  : 0.854  : Unitless,            Kidney    / plasma PC; (from Mice PBPK model)
PRest               : 0.595   : Unitless,            Restofbody/ plasma PC; (from Mice PBPK model)

Kabsc               : 0.286  : 1/(h*BW^-0.25),      Rate of absorption of GenX  from small intestine to liver; (from equ)
K0C                 : 0.135  : 1/(h*BW^-0.25),      Rate of uptake from the stomach into the liver (initial value assumed the same as PFOA (1) from Worley and Fisher, 2015 and then from equ)
KunabsC             : 0.0036 : 1/(h*BW^-0.25),      Rate of unabsorbed dose to appear in feces; (from equ) 
KurineC             : 0.0165 : 1/(h*BW^-0.25),      Rate of urine elimination from urine storage (male); (from equ) 
