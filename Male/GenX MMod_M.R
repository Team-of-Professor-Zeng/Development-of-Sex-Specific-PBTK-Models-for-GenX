...
Free                :   0.006 : Unitless,            Free fraction; (Loccisano 2012)  
...
KunabsC             :  0.00140 : 1/(h*BW^-0.25),      Rate of unabsorbed dose to appear in feces; (initial value assumed the same as PFOA (0.0000706) from Worley and Fisher, 2015 and then re-fitting) 
KurineC             :  0.0628  : 1/(h*BW^-0.25),      Rate of urine elimination from urine storage; (Gannon 2015)  
...
double VRest = (0.93*BW)-VL-VLu-VK-VPlas-Vfil;            // L,   Rest of body; volume of remaining tissue (L); Revised original equation (VR = (0.93*BW) - VPlas - Vfil - VL) from Worley and Fisher, 2015  
...
$INIT @annotated
ADOSE:0.25: mg, Amount of input dose; assumed a virtual compartment for validating the model mass balance 
