...
write.csv(NSC_Clean, file = "NSC_H_M.csv", row.names = FALSE)
...
ggsave("Figure S6-human-Male.tiff",scale = 1,
       plot = p1,
...
write.csv(PlotDat_A1, file = "PlotDat_A1_M1000.csv", row.names = FALSE)
...
H_CPlas
write.csv(H_CPlas, file = "H_CPlas_M.csv", row.names = FALSE)
