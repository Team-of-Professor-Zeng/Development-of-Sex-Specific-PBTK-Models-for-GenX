...
BW                  : 73      : kg,                  Bodyweight (ICRP 2002)
QCC                 : 15.62   : L/h/kg^0.75,         ICRP 2002
QLC                 : 0.25    : Unitless,            Fraction blood flow to liver (ICRP 2002)
QLuC                : 0.025   : Unitless,            Pulmonary circulation equals systemic circulation(ICRP 2002)
QKC                 : 0.19	  : Unitless,            Fraction blood flow to kidney (ICRP 2002)
Htc                 : 0.434   : Unitless,            Hematocrit for human(ICRP 2002)
VPlasC              : 0.0411  : L/kg BW,             Fractional plasma (ICRP 2002)
VLC                 : 0.0247  : Unitless,            Fractional liver tissue (ICRP 2002)
VLuC                : 0.0068  : Unitless,            Fractional lung tissue (ICRP 2002)
VKC                 : 0.0042  : Unitless,            Fractional kidney tissue (ICRP 2002)
VfilC               : 0.00042 : L/kg BW,             Fraction vol. of filtrate; 10% of Kidney volume; (Worley and Fisher et al., 2015)
...
Free                : 0.0106 : Unitless,            Free fraction; (from Mice PBPK model)  
PL                  : 0.753  : Unitless,            Liver     / plasma PC; (from Mice PBPK model) 
PLu                 : 2.0399 : Unitless,            Lung      / plasma PC; (from Mice PBPK model)
PK                  : 0.854  : Unitless,            Kidney    / plasma PC; (from Mice PBPK model)
PRest               : 0.14   : Unitless,            Restofbody/ plasma PC; (from Mice PBPK model)

Kabsc               : 0.142  : 1/(h*BW^-0.25),      Rate of absorption of GenX  from small intestine to liver; (from equ)
K0C                 : 0.25  : 1/(h*BW^-0.25),      Rate of uptake from the stomach into the liver (initial value assumed the same as PFOA (1) from Worley and Fisher, 2015 and then from equ)
KunabsC             : 0.00019: 1/(h*BW^-0.25),      Rate of unabsorbed dose to appear in feces; (from equ) 
KurineC             : 0.00854: 1/(h*BW^-0.25),      Rate of urine elimination from urine storage (male); (from equ) 
...
$CMT ADOSE APlas_free AUCCA_free AFil AUCCfil Aurine ARest AUCCRest AST AabsST ASI AabsSI Afeces AL AUCCL ALu AUCCLu AKb AUCCK
...
double Cfil = AFil/Vfil;                             // mg/L, Concetraitons of GenX  in Fil
